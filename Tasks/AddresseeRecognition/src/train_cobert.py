...
if __name__ == "__main__":  
    ...
    parser.add_argument("--history_post_path", default="ProcessedData/text_profile_512.json", type=str)
    parser.add_argument("--persona_id_path", default="Dataset/ProcessedData/basic_profile.json", type=str)
